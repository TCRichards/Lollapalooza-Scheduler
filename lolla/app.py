...
if __name__ == "__main__":
    ...
    def update_video_embed(current_idx, video_idx):
        ...
        if not artist_names:
            return html.Div("No artists found for this hour.")
        if video_idx >= len(artist_names):
    ...
    if __name__ == "__main__":
        # Access the app with localhost instead of 127.0.0.1 to support iframe embedding
        app.run(debug=True)